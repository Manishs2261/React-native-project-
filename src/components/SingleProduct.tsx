...
const SingleProduct =()=>{
 ...
 <ScrollView>
    ...
    <View style={{flexDirection:'row',justifyContent:'space-between' , marginTop:30 ,alignItems:'center'}}>
         ...
         <Text style={{fontSize:30,fontWeight:'600',color:'black'}}>SAR 2600</Text>
         <Text style={{fontSize:15,fontWeight:'600', textDecorationLine:"line-through" ,alignSelf:'flex-start'}}>SAR 2600</Text>
         </View>
